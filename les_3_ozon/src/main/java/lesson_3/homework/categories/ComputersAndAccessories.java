...
public class ComputersAndAccessories extends Category {
    private String categoryName;

    public ComputersAndAccessories() {
        super(ICON_COMPUTERS_AND_ACCESSORIES, NAME_COMPUTERS_AND_ACCESSORIES);
