...
public class HeadphonesAndAudioEquipment extends Category {
    private String categoryName;

    public HeadphonesAndAudioEquipment() {
        super(ICON_HEADPHONES_AND_AUDIO_EQUIP, NAME_HEADPHONES_AND_AUDIO_EQUIP);
